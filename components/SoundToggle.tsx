/**
 * Green Tycoon - Sound Toggle Component
 *
...
export default function SoundToggle() {
  const { enabled, setEnabled, play } = useSoundManager();
  ...
  return (
    <button
      ...
      className="bg-white/20 hover:bg-white/30 backdrop-blur-sm p-2 rounded-xl transition-all hover:scale-105"
